(self["webpackChunkkenzo_workout_suite"] = self["webpackChunkkenzo_workout_suite"] || []).push([["common"],{
...
/* harmony export */ });
class Exercise {
    constructor(title, description, repRange, sets, poseDescription, restPeriod, tags, duratime, images) {
        this._title = title;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "KenzoTag": () => (/* binding */ KenzoTag)
/* harmony export */ });
class KenzoTag {
    constructor(textColour, backgroundColour, label, selected) {
